...
/**
 * ATOMIC FCA Enhanced Error Handling System
...
class LoginError extends AtomicError {
...
class NetworkError extends AtomicError {
...
class ValidationError extends AtomicError {
...
class RateLimitError extends AtomicError {
        ...
        try {
            ...
            if (result.recovery && result.recovery.retry) {
                ...
                if (error.retryCount > 3) {
                    throw new AtomicError('Max retry attempts exceeded', 'MAX_RETRIES_EXCEEDED');
                }
                throw error;
            }
