...
class UserAgentManager {
    ...
    buildUserAgentPool() {
        return [
            ...
            // Firefox on macOS
            {
                ua: "Mozilla/5.0 (Macintosh; Intel Mac OS X 15.4; rv:137.0) Gecko/20100101 Firefox/137.0",
                browser: "Firefox",
                os: "macOS",
                version: "137"
            },
            ...
            {
                ua: "Mozilla/5.0 (Macintosh; Intel Mac OS X 15_3_2) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3.1 Safari/605.1.15",
                browser: "Safari",
                os: "macOS",
                version: "18.3.1"
            },
    ...
    getUserAgent(options = {}) {
        ...
        // Default fallback
        if (!this.currentUA) {
            this.currentUA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36";
        }
     ...
     */
    static fromEnv() {
        const randomEnabled = process.env.ATOMIC_RANDOM_USER_AGENT === 'true';
        const customUA = process.env.ATOMIC_USER_AGENT;
