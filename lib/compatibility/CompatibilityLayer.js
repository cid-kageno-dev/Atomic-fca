...
/**
 * Compatibility Layer for ATOMIC FCA
...
class CompatibilityLayer {
    ...
    createLegacyApi() {
        return {
            ...
            convertMessage: (message, targetFormat = 'atomic') => {
                const formats = {
                    'atomic': (msg) => ({
            ...
            migrateFromFcaUnofficial: (oldApi) => {
                console.log('Migrating from fca-unofficial to ATOMIC FCA...');
            ...
            migrateFromWs3Fca: (oldApi) => {
                console.log('Migrating from ws3-fca to ATOMIC FCA...');
