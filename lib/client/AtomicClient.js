...
// ATOMIC FCA: Modern Client Class with Discord.js style API
...
class AtomicClient extends EventEmitter {
    constructor(options = {}) {
        super();
    ...
    _handleMessage(event) {
        ...
        const message = new AtomicMessage(this, event);
     ...
     * @private
     * @param {AtomicMessage} message - Message object
...
module.exports = { AtomicClient, AtomicMessage };
