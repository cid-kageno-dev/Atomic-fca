// ATOMIC FCA: Advanced TypeScript Definitions
// Enhanced with modern types and better error handling

declare module 'atomic-fca' {
    ...
    interface AtomicError extends Error {
        code?: string;
        statusCode?: number;
        details?: any;
        retryable?: boolean;
    ...
    interface AtomicMessage {
        ...
        reactions: AtomicReaction[];
        replyTo?: AtomicMessage;
        isEdited: boolean;
        editHistory: string[];
        
        // Methods
        reply(content: string | MessageOptions): Promise<AtomicMessage>;
        ...
        getThread(): Promise<AtomicThread>;
        getAuthor(): Promise<AtomicUser>;
    }

    // Enhanced User Structure
    interface AtomicUser {
        id: string;
        name: string;
        firstName?: string;
        lastName?: string;
        ...
        // Methods
        sendMessage(content: string | MessageOptions): Promise<AtomicMessage>;
        addAsFriend(): Promise<void>;
        block(): Promise<void>;
        unblock(): Promise<void>;
        getSharedThreads(): Promise<AtomicThread[]>;
        getProfilePicture(): Promise<string>;
        changeBio(bio: string): Promise<void>;
    }

    // Enhanced Thread Structure
    interface AtomicThread {
        id: string;
        name?: string;
        ...
        emoji?: string;
        color?: string;
        participants: AtomicUser[];
        participantCount: number;
        isGroup: boolean;
        isArchived: boolean;
        isPinned: boolean;
        isMuted: boolean;
        lastMessage?: AtomicMessage;
        ...
        // Methods
        sendMessage(content: string | MessageOptions): Promise<AtomicMessage>;
        getHistory(limit?: number, before?: number): Promise<AtomicMessage[]>;
        ...
        getParticipants(): Promise<AtomicUser[]>;
        getAdmins(): Promise<AtomicUser[]>;
    ...
    // Client Class
    class AtomicClient extends NodeEventEmitter {
        constructor(options?: AtomicClientOptions);
        ...
        on(event: 'message', listener: (message: AtomicMessage) => void): this;
        on(event: 'command', listener: (command: { name: string; args: string[]; message: AtomicMessage }) => void): this;
        on(event: 'error', listener: (error: AtomicError) => void): this;
        on(event: 'reconnect', listener: () => void): this;
        on(event: 'disconnect', listener: () => void): this;
        on(event: 'userOnline', listener: (user: AtomicUser) => void): this;
        on(event: 'userOffline', listener: (user: AtomicUser) => void): this;
        on(event: 'threadUpdated', listener: (thread: AtomicThread) => void): this;
        on(event: 'messageReaction', listener: (reaction: AtomicReaction, message: AtomicMessage) => void): this;
        on(event: 'messageEdit', listener: (oldMessage: AtomicMessage, newMessage: AtomicMessage) => void): this;
        on(event: 'messageUnsend', listener: (message: AtomicMessage) => void): this;
        on(event: 'typingStart', listener: (user: AtomicUser, thread: AtomicThread) => void): this;
        on(event: 'typingStop', listener: (user: AtomicUser, thread: AtomicThread) => void): this;
    }

    // Command Handler Type
    // Command Handler Type
    type CommandHandler = (args: string[], message: AtomicMessage, api: IFCAU_API) => Promise<void> | void;

    // Middleware Type
    type Middleware = (message: AtomicMessage, next: () => void) => void;
    ...
    class EnhancedDatabase extends NodeEventEmitter {
        ...
        // User management
        saveUser(user: Partial<AtomicUser>): Promise<AtomicUser>;
        getUser(userId: string): Promise<AtomicUser | null>;
        
        // Thread management
        saveThread(thread: Partial<AtomicThread>): Promise<AtomicThread>;
        getThread(threadId: string): Promise<AtomicThread | null>;
        
        // Message management
        saveMessage(message: Partial<AtomicMessage>): Promise<AtomicMessage>;
        getMessages(threadId: string, limit?: number, before?: number): Promise<AtomicMessage[]>;
    ...
    class CompatibilityLayer {
        ...
        // ATOMIC FCA compatibility utilities
        createWrapper(packageName: 'atomic-fca'): any;
        createLegacyApi(): any;
