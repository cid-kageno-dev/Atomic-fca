...
This directory contains comprehensive examples demonstrating the features and capabilities of ATOMIC FCA.
...
A sophisticated bot using the modern AtomicClient with command system.
...
3. ATOMIC FCA package installed
...
```javascript
const { AtomicClient } = require('../lib/client/AtomicClient');
